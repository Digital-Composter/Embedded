...
void getState() {
  if (wifiMulti.run() == WL_CONNECTED) {
    HTTPClient http;
    http.begin("https://digicomp.vercel.app/state");
...
void getControl() {
  if (wifiMulti.run() == WL_CONNECTED) {
    HTTPClient http;
    http.begin("https://digicomp.vercel.app/control");
...
void getDays() {
  if (wifiMulti.run() == WL_CONNECTED) {
    HTTPClient http;
    http.begin("https://digicomp.vercel.app/state/days");
                      ...
                      float heater, float exhaust ) 
{
  ...
  LoRa.print("c1:"); LoRa.print(c1); LoRa.print(",");
  LoRa.print("c2:"); LoRa.print(c2); LoRa.print(",");
  LoRa.print("c3:"); LoRa.print(c3); LoRa.print(",");
  LoRa.print("lw1:"); LoRa.print(lw1); LoRa.print(",");
  LoRa.print("lw2:"); LoRa.print(lw2); LoRa.print(",");
  LoRa.print("lw3:"); LoRa.print(lw3); LoRa.print(",");
  LoRa.print("w1:"); LoRa.print(w1); LoRa.print(",");
  LoRa.print("w2:"); LoRa.print(w2); LoRa.print(",");
  LoRa.print("w3:"); LoRa.print(w3); LoRa.print(",");
