...
void parseLoRaMessage(String message) {
  ...
  float c1 = getValue(message, "c1").toFloat();
  float c2 = getValue(message, "c2").toFloat();
  float c3 = getValue(message, "c3").toFloat();
  float lw1 = getValue(message, "lw1").toFloat();
  float lw2 = getValue(message, "lw2").toFloat();
  float lw3 = getValue(message, "lw3").toFloat();
  float w1 = getValue(message, "w1").toFloat();
  float w2 = getValue(message, "w2").toFloat();
  float w3 = getValue(message, "w3").toFloat();
